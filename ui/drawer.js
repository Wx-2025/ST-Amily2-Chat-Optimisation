...
export async function createDrawer() {
  ...
  if (location === 'topbar') {
    ...
    // 使用与st-memory-enhancement完全一致的HTML结构，确保兼容性
